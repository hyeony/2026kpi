  ...
  return (
    <>
      <section style={sectionStyle}>
        <h2>PromptInput — 기본 (Provider 없이)</h2>
        ...
        {log.length > 0 && (
          <pre style={{ marginTop: "12px", fontSize: "12px", color: "#6b7280", background: "#f9fafb", padding: "10px", borderRadius: "6px" }}>
            {log.join("\n")}
          </pre>
        )}
      </section>
      ...
      <section style={sectionStyle}>
        ...
        <p style={{ color: "#6b7280", fontSize: "14px", marginBottom: "12px" }}>
          prefix 변경 시 CSS 클래스명이 custom-prompt-* 로 교체됩니다.
        </p>
